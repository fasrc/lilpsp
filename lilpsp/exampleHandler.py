...
def dynamicPNG(req):
	...
	try:
		...
		#example of how to handle anticipated Exceptions (in practice, replace exampleHandlerFailure.psp here with a more specific error page, modeled after exampleHandlerFailure.psp)
		try:
